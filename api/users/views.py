...
user_namespace = Namespace('user', description='name space for authentication')
...
@user_namespace.route('/students/<int:students_id>')
...
@user_namespace.route('/user/<int:user_id>/user/<int:user_id>')
class GetSpecificOrderByUser(Resource):

    def get(self, user_id, courses_id):
        """"
                Get a specific order
        """
        pass

@user_namespace.route('/user/<int:user_id>/user')
...
@user_namespace.route('/route/status/<int:user_id>')
class updateStudentsStatus(Resource):
